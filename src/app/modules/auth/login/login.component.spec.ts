...
fdescribe('LoginComponent', () => {
  ...
  it('should have three social login icons', () => {
    const socialIcons = fixture.debugElement.queryAll(By.css('div img'));
  ...
  it('should display "Don\'t have an account? Register" link', () => {
    const registerLink = fixture.debugElement.query(By.css('span a')).nativeElement;
